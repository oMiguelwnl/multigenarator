...
_FUNCTION_WORD_LABELS = {
    ...
    "el": _language_map(
        {
            "article": ("ο", "η", "το", "οι", "τα", "ένας", "μια", "ένα"),
            "preposition": ("σε", "με", "για", "από", "προς", "χωρίς", "μεταξύ", "κατά"),
            "conjunction": ("και", "αλλά", "ότι", "πως", "επειδή", "όταν"),
            "pronoun": ("εγώ", "εσύ", "αυτός", "αυτή", "αυτό", "εμείς", "εσείς", "αυτοί", "αυτές", "κάτι", "τίποτα", "όλα", "κάποιος", "κανείς"),
            "particle": ("δεν", "μη", "να"),
        }
    ),
    "it": _language_map(
    ...
    "zh": _language_map(
        {
            "particle": ("的", "了", "着", "过", "吗", "呢", "吧"),
            "conjunction": ("和", "与", "及", "或", "但是", "因为", "所以"),
            "pronoun": ("我", "你", "他", "她", "它", "我们", "你们", "他们", "这", "那", "谁", "什么"),
            "preposition": ("在", "从", "向", "对", "给", "跟", "关于"),
        }
    ),
    "la": _language_map(
        {
