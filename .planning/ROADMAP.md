...
- [ ] **Phase 1: Job Orchestration & Recovery** - Start supported-language jobs with visible progress, resumability, and duplicate-safe reruns. _(in progress: 1/4 plans)_
...
|-------|----------------|--------|-----------|
| 1. Job Orchestration & Recovery | 1/4 | In progress | 2026-04-18 |
